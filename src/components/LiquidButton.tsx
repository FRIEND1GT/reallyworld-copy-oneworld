...
export default function LiquidButton({ 
  ...
  return (
    <>
      <button 
        onClick={handleOpen}
        className="relative block w-full h-14 rounded-xl font-bold text-white bg-white/[0.03] border border-white/10 overflow-hidden group transition-all hover:border-white/20 hover:shadow-[0_0_20px_rgba(255,255,255,0.05)]"
      >
        <div className="absolute inset-0 z-10 flex items-center justify-center gap-3 drop-shadow-md">
        ...
        {/* Liquid elements */}
        <motion.div 
          className="absolute left-1/2 top-[50px] w-[200px] h-[200px] -translate-x-1/2 rounded-[40%] transition-all duration-500 group-hover:top-[-20px] opacity-40 mix-blend-screen"
          style={{ backgroundColor: color1 }}
          animate={{ rotate: 360 }}
          transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
        />
        <motion.div 
          className="absolute left-1/2 top-[55px] w-[210px] h-[210px] -translate-x-1/2 rounded-[45%] transition-all duration-500 group-hover:top-[-15px] opacity-40 mix-blend-screen"
